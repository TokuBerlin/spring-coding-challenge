...
//
/**
 * xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx [toku]  xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
 * @author Thomas Kuhn
 */
function create_toku_posttype()
{
	$labels = array(
...
//		'taxonomies' 		=> array('category', 'post_tag'),
	...
	register_post_type('toku_books', $args);
}

add_action('init', 'create_toku_posttype', 0);
